...
// import { filterProps } from '../components/utils/react/react-shush-error';
// import WSListener from '../ws-listener';

// all separate pages should be wrapped by this
const PageWrapper = (props) => {
  // const dispatch = useDispatch();
  // const dropdown = useSelector((s) => s.ui.openDropdown);
  // const devMode = useSelector((s) => s.config.devMode);
